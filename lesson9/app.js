...
//lấy ra giá trị của thuộc tính 'firstName'
...
// mySelf1.phoneNumber = '4532234342';//Hoặc
// mySelf1['phoneNumber'] ='4532234342';
// //thêm thuộc tính
...
// let a = 0;
// let b = 0;
// function inputNumber(lable){
//     let input = NaN;
// do{
//     input = Number(prompt("Nhập vào số " +lable+ ": " ));
// } while(isNaN(input));
// return input;//trả về giắ trị khi gọi hàm và không thực thi các đoạn code bên dưới
// }
...
// let res = sayHello();//undefine
// executeAfterSeconds(3, res);
// executeAfterSeconds(5, doSomthing);

// const doAnything = () => {

// }

// const doNothing = (a, b, c, d) => "Hello"; //hoặc
...
// }
// let nghiem = timNghiemptb2(1, -3, -4);
// console.log(nghiem);
...
// let test = checkTamgiac(3, 4, 5);
// console.log(test);
// let tg = kiemTra3CanhTG(3, 4, 5);
// console.log(tg);
